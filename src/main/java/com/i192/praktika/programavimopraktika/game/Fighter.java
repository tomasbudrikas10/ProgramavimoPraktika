...
public class Fighter {
    ...
    public Fighter (String name) {
        ...
        Animation[] animationArr = new Animation[8];
        {
            animationArr[0] = new Animation(name + "/idle.png",name + "/idle.txt");
            animationArr[1] = new Animation(name + "/walk.png",name + "/f_walk.txt");
            animationArr[2] = new Animation(name + "/walk.png",name + "/b_walk.txt");
            animationArr[3] = new Animation(name + "/punch.png",name + "/punch.txt");
            animationArr[4] = new Animation(name + "/kick.png",name + "/kick.txt");
            animationArr[5] = new Animation(name + "/block.png",name + "/block.txt");
            //animationArr[6] = new Animation(name + "/fall.png",name + "/fall.txt");
            animationArr[7] = new Animation(name + "/jump.png",name + "/jump.txt");
        }
        this.animations = animationArr;
        ...
        this.inputUpBoolLamdaMap = new HashMap<>();
        {
            ...
            inputUpBoolLamdaMap.put(Inputs.RIGHT, characterState -> {
                characterState.looping = null;
                if(characterState.animation == 1 || characterState.animation == 2){
                    characterState.animation = 0;
                    characterState.animationFrame = 0;
                }
                return false;
            });
            inputUpBoolLamdaMap.put(Inputs.LEFT, characterState -> {
